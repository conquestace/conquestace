...
| `LLMConfig.astro`                     | Manage **multiple LLM slots**. Default slot uses **Gemini** (`gemini-2.0-flash`).<br>• Add or delete slots for **OpenAI** or **Local** endpoints.<br>• Stores keys and model names in `localStorage`.
